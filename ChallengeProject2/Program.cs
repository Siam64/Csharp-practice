...
do
{
    ...
    Console.WriteLine("Welcome to the Your PetFriends app. Your main menu options are:");
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ") // Check if the row is not empty
                {
                    if (ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd")
                    {
                        Console.WriteLine($"Missing information for animal with ID: {ourAnimals[i, 0]}");
                        ...
                        if (ourAnimals[i, 2] == "Age: ?")
                        {
                            ...
                            do
                            {
                                ...
                                if (readResult != null)
                                {
                                    ...
                                    if (age != "?")
                                    {
                                        validEntry = int.TryParse(age, out petAge);
                                        if (validEntry)
                                        {
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        Console.WriteLine($"Information missing of id {ourAnimals[i, 0]}");
